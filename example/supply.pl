...
happens(verify(winery, "audit1", claim(bottle_1, "organic", 1001), 1.0), 1001).
...
happens(verify(organic_transportation, "audit2", claim(bottle_1, no_change(1001), 1101), 1.0), 1101).

% % Retailer handles the bottle
happens(handle(retailer, bottle_1), 1200).
% % Claims that the bottle was not changed in an inorganic way
happens(verify(retailer, "audit3", claim(bottle_1, no_change(1101), 1201), 1.0), 1201).
