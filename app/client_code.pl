...
initially(judgement(customer, [magic], [claim(O, "organic", T1), claim(O, no_change(T1), T2), constraint(T1 < T2)] ==> claim(O, "organic", T2))=1.0).
initially(judgement(customer2, [magic], [claim(O, "organic", T1), claim(O, no_change(T1), T2), constraint(T1 < T2)] ==> claim(O, "organic", T2))=1.0).
...
happens(verify(winery, "audit_1", claim(bottle_1, "organic", 1001), 1.0), 1001).
...
happens(verify(organic_transportation, "audit_2", claim(bottle_1, no_change(1001), 1101), 1.0), 1101).

% % Retailer handles the bottle
happens(handle(retailer, bottle_1), 1200).
% % Claims that the bottle was not changed in an inorganic way
happens(verify(retailer, "audit_3", claim(bottle_1, no_change(1101), 1201), 1.0), 1201).
